...
export function NotionPromptForm() {
  ...
  const [selectedModel, setSelectedModel] = useState(
    SAMPLE_DATA.models[0] as (typeof SAMPLE_DATA.models)[number]
  )
    ...
    <DemoShell>
      <form>
        <Field>
          ...
          <InputGroup className="h-auto rounded-[1.5rem]">
            <InputGroupTextarea
              id="notion-prompt"
                          ...
                          <CommandList>
                            ...
                            <CommandGroup>
                              {SAMPLE_DATA.mentionable
                                ...
                                .map((user) => (
                                  <CommandItem key={user.title} value={user.title}>
                                    <Avatar className="size-4">
